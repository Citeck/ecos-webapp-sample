package ru.citeck.ecos.webapp.sample.domain.test;
...
import ru.citeck.ecos.webapp.sample.simple.StatelessWebAppSample;
import ru.citeck.ecos.webapp.sample.simple.domain.test.api.records.SimpleRecordsDao;
...
public class SimpleRecordsDaoTest {
